      ...
      <section className="relative pt-28 sm:pt-32 pb-24 sm:pb-28 bg-hero-gradient overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <p className="text-blue-700 font-semibold text-sm uppercase tracking-widest mb-3">{t('adm_tag', lang)}</p>
            ...
            >
              {[
                { icon: Clock, label: '2-Week Decision', sub: 'Fast application review', gradient: 'from-blue-700 to-blue-800' },
                { icon: Globe, label: '40+ Countries', sub: 'International student body', gradient: 'from-sky-500 to-blue-700' },
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-12 sm:mb-16">
            <p className="text-blue-700 font-semibold text-xs sm:text-sm uppercase tracking-widest mb-3">{t('adm_steps_tag', lang)}</p>
      ...
      <section className="py-16 sm:py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-10 sm:mb-14">
            <p className="text-blue-700 font-semibold text-xs sm:text-sm uppercase tracking-widest mb-3">{t('adm_req_tag', lang)}</p>
          ...
          >
            ...
            {/* International */}
            <motion.div variants={fadeUp} className="card p-6 sm:p-8 overflow-hidden relative">
              <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-blue-400 to-blue-700" />
              <div className="flex items-center gap-3 mb-5 sm:mb-6">
