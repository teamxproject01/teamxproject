      ...
      <section className="relative pt-28 sm:pt-32 pb-24 sm:pb-32 bg-hero-gradient overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <p className="text-blue-700 font-semibold text-xs sm:text-sm uppercase tracking-widest mb-3">{t('about_tag', lang)}</p>
            ...
            >
              <div className="relative">
                ...
                >
                  ...
                  <p className="text-xs text-blue-700 font-semibold mt-2">— Prof. David Nguyen, Vice-Chancellor</p>
                </motion.div>
              </div>
            </motion.div>
          </div>
          ...
          >
            {statsRow.map(({ value, label }) => (
              <motion.div key={label} variants={fadeUp} className="text-center">
                <div className="text-3xl sm:text-4xl font-black text-blue-700 mb-1">{value}</div>
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-10 sm:mb-14">
            <p className="text-blue-700 font-semibold text-xs sm:text-sm uppercase tracking-widest mb-3">{t('about_mvv_tag', lang)}</p>
      ...
      <section className="py-12 sm:py-16 bg-slate-50 overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="text-center mb-10 sm:mb-12">
            <p className="text-blue-700 font-semibold text-sm uppercase tracking-widest mb-3">{t('about_history_tag', lang)}</p>
                ...
                >
                  <div className={`hidden md:block flex-1 ${i % 2 === 0 ? 'text-right pr-10' : 'text-left pl-10'}`}>
                    <div className="card p-5 inline-block shadow-card">
                      <span className="text-2xl font-black text-blue-700">{year}</span>
                  ...
                  <div className="flex-1 md:hidden">
                    <span className="text-lg font-bold text-blue-700">{year}</span>
