...
const info = [
  ...
  { icon: Phone, title: 'Phone', lines: ['+61 3 9000 1234', '+61 3 9000 5678 (International)'], color: 'from-sky-500 to-blue-700' },
  { icon: Mail, title: 'Email', lines: ['info@mihe.edu.au', 'admissions@mihe.edu.au'], color: 'from-blue-700 to-blue-800' },
  { icon: Clock, title: 'Office Hours', lines: ['Mon – Fri: 8:30am – 5:30pm', 'Sat: 10:00am – 2:00pm'], color: 'from-blue-400 to-blue-700' },
];
      ...
      <section className="relative pt-28 sm:pt-32 pb-20 sm:pb-24 bg-hero-gradient overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="max-w-2xl"
          >
            <p className="text-blue-700 font-semibold text-sm uppercase tracking-widest mb-3">{t('contact_tag', lang)}</p>
              ...
              <div className="relative h-48 sm:h-64 bg-gradient-to-br from-blue-50 to-sky-100 rounded-2xl border border-blue-100 overflow-hidden mb-6 sm:mb-8 shadow-card">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center bg-white/80 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-card">
                    <div className="w-10 h-10 bg-blue-700 rounded-full flex items-center justify-center mx-auto mb-2">
                    ...
                    <p className="text-xs text-blue-700 font-medium mt-1">Near Flinders Street Station</p>
                  </div>
                </div>
              </div>
            ...
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }}>
              <div className="card p-6 sm:p-8 shadow-card-hover">
                <div className="flex items-center gap-3 mb-5 sm:mb-6">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 bg-blue-700 rounded-xl flex items-center justify-center">
