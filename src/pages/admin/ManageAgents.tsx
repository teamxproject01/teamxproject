      ...
      if (agentEmail) {
        try {
          ...
          const subject = status === 'approved'
            ? 'Your MIHE Agent Account Has Been Approved'
            : 'Your MIHE Agent Application Has Been Rejected';
          const html = status === 'approved'
            ? `<div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
                <h2 style="color: #1e3a5f;">MIHE Agent Portal</h2>
                <p>Hi there,</p>
                <p>Great news! Your agent application for <strong>${agent.agency_name}</strong> has been <strong style="color: #16a34a;">approved</strong>.</p>
                <p>You can now log in to the MIHE Agent Portal to create and submit student applications.</p>
                <div style="margin: 24px 0;">
                  <a href="${window.location.origin}/login" style="display: inline-block; background: #1e3a5f; color: #ffffff; padding: 12px 28px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 14px;">Log In to Agent Portal</a>
                </div>
                <p style="color: #64748b; font-size: 13px;">If you have any questions, please contact the MIHE admissions team.</p>
                <br><p>Best regards,<br>MIHE Admissions Team</p>
              </div>`
            : `<div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
                <h2 style="color: #1e3a5f;">MIHE Agent Portal</h2>
                <p>Hi there,</p>
                <p>We're sorry to inform you that your agent application for <strong>${agent.agency_name}</strong> has been <strong style="color: #dc2626;">rejected</strong>.</p>
          ...
          await fetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/send-email`, {
            ...
            body: JSON.stringify({ to: agentEmail, subject, html }),
          });
        } catch {
