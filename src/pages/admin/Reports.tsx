...
const formVolumes = [
  ...
  { name: 'General Enquiry', value: 36, color: '#1e3a8a' },
...
export default function Reports() {
  const kpis = [
    ...
    { label: 'Avg. Processing Time', value: '4.3 days', trend: '-0.8d', icon: BarChart2, color: 'text-blue-700 bg-blue-50' },
    { label: 'Student Satisfaction', value: '4.8/5.0', trend: '+0.2', icon: Users, color: 'text-amber-600 bg-amber-50' },
    { label: 'Forms Resolved', value: '92%', trend: '+3%', icon: FileText, color: 'text-blue-700 bg-blue-50' },
  ];
  ...
  return (
    <div className="space-y-6 max-w-6xl">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="card p-6">
          <h3 className="font-bold text-slate-900 mb-4 flex items-center gap-2">
            <PieIcon className="w-5 h-5 text-blue-700" />
