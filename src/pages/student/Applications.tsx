                ...
                <div key={app.id} className={`card p-6 ${
                  ...
                  {app.offer_letter_path && (
                    <div className="mt-4 p-3 bg-indigo-50 rounded-xl border border-indigo-100">
                      ...
                      <button
                        onClick={() => handleDownload(app.offer_letter_path!)}
                      ...
                      {app.offer_accepted && app.signed_offer_path && (
                        <div className="mt-2 pt-2 border-t border-indigo-100">
                          ...
                          <button
                            onClick={() => handleDownload(app.signed_offer_path!)}
                            className="text-xs text-blue-700 font-semibold hover:underline flex items-center gap-1"
                          >
                  ...
                  {app.coe_path && (
                    <div className="mt-3 p-3 bg-emerald-50 rounded-xl border border-emerald-100">
                      ...
                      <button
                        onClick={() => handleDownload(app.coe_path!)}
                        className="text-xs text-blue-700 font-semibold hover:underline flex items-center gap-1"
                      >
                  ...
                  {app.enrollment_url && (
                    <div className="mt-3 p-3 bg-blue-50 rounded-xl border border-blue-100">
                      ...
                      <a href={app.enrollment_url} target="_blank" rel="noopener noreferrer" className="text-xs text-blue-700 font-semibold hover:underline flex items-center gap-1">
