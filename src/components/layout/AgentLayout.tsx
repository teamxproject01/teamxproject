...
import {
  ...
  LogOut, Menu, ChevronRight, PlusCircle, CalendarDays,
} from 'lucide-react';
...
const navItems = [
  ...
  { icon: CalendarDays, label: 'Calendar', href: '/agent/calendar' },
...
export default function AgentLayout() {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on('postgres_changes',
        { event: '*', schema: 'public', table: 'agent_notifications', filter: `user_id=eq.${profile.id}` },
        fetchCount
      )
      .subscribe();
