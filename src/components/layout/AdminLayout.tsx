...
import {
  ...
  BarChart2, LogOut, Menu, ChevronRight, Shield, BookOpen, Users, Video, Image, Library, ShieldCheck, Inbox, CalendarDays,
} from 'lucide-react';
...
const navItems = [
  ...
  { icon: ShieldCheck, label: 'GSA', href: '/admin/gsa' },
  ...
  { icon: Library, label: 'Doc Library', href: '/admin/document-library' },
  { icon: Image, label: 'Hero Banner', href: '/admin/hero-banner' },
  { icon: Video, label: 'Videos', href: '/admin/video-management' },
