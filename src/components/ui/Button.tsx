...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'primary', size = 'md', loading, disabled, children, className = '', ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-blue-700 text-white hover:bg-blue-800 active:bg-blue-900 shadow-blue focus:ring-blue-500',
      secondary: 'bg-white text-blue-700 border-2 border-blue-200 hover:border-blue-400 hover:bg-blue-50 focus:ring-blue-400',
      ghost: 'text-blue-700 hover:bg-blue-50 active:bg-blue-100 focus:ring-blue-400',
