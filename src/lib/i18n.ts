...
const translations = {
  ...
  home_slide6_tag:  { en: 'Open Day',                                zh: '校园开放日' },
  home_slide6_h1:   { en: 'Step Inside',                              zh: '走进' },
  home_slide6_h2:   { en: 'Our Campus',                               zh: '我们的校园' },
  home_slide6_sub:  { en: 'Meet your future lecturers, tour our Melbourne CBD facilities, and picture yourself here — all in one Saturday.', zh: '与未来的导师面对面，参观墨尔本CBD校区设施，在一个周六里预见你的大学生活。' },
  home_slide6_cta:  { en: 'Register Now',                           zh: '立即注册' },
  home_slide6_cta2: { en: 'Learn More',                              zh: '了解更多' },
